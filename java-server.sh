...
APP_MAINCLASS=com.idw.mina.service.server.MinaServer
 
# 拼凑完整的classpath参数，包括指定lib目录下所有的jar
CLASSPATH="./"
for i in WebRoot/WEB-INF/lib/*.jar;
do
...
JAVA_OPTS="-Duser.timezone=GMT+8 -server -Xms256m -Xmx4096m -XX:PermSize=288m -XX:MaxPermSize=288m -Dcom.sun.management.jmxremote -Djava.rmi.server.hostname=182.140.239.110 -Dcom.sun.management.jmxremote.port=3334 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
